                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="dropdown d-lg-none">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <div class="list-group border border-0" id="list-tab"
                                                                    role="tablist">
                                                                    <?php
                                                    ...
                                                    WHERE s.swot_category = '" . $row->swot_category . "'")->fetch_object();
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="card border border-1">
                                                                ...
                                                                <div class="card-body pt-3"
                                                                    style="height: 300px;overflow-y: auto; font-size: 0.75em;">
                                                                    <ul>
                                                                        <?php
                                        ...
                                        <?php
                                        function displayResults2($query, $range)
                                        {
                                            global $conn;
                                            $result = $conn->execute_query($query, $range);
                                            $items = [];
                                        ...
                                        <div class="col-md-12">
                                            <div class="card border border-1">
                                                ...
                                                <div class="card-body pt-3 small">
                                                    <p class="lh-base">
                                                        <?= $get_msme->business_name ?> with Code:
                                                        <?= $get_msme->msme_code ?> has a high success rate based
                                                        on the result of the MSME assessment with high regards to
                                                        <?php
                                                        displayResults2($query, [81, 100]);
                                                        ?>
                                                    </p>
                                                    <p class="lh-base">
                                                        The business has invested in proper strategic planning,
                                                        excellent
                                                        leadership skills, and knowledge of the market. The business
                                                        owner
                                                        aims to improve advertising products to a wide range of
                                                        prospective
                                                        buyers, pitch his/her products and services effectively, and
                                                        develop
                                                        online marketing strategies. In the competitor-feature
                                                        scorecard,
                                                        the company has accomplished fewer features compared to other
                                                        competitors in the same business landscape.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
